...
public class ScopeBlockForSlice extends ScopeTree {
    ...
    private List<String> scopeIn=new ArrayList<>();//作用域内部内容
    private List<String> scopeOut=new ArrayList<>();//作用域外部内容
    ...
    public List<String> getScopeIn() {
        return scopeIn;
    }

    public void setScopeIn(List<String> scopeIn) {
        this.scopeIn = scopeIn;
    }

    public List<String> getScopeOut() {
        return scopeOut;
    }

    public void setScopeOut(List<String> scopeOut) {
