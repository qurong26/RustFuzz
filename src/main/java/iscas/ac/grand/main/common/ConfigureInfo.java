...
public class ConfigureInfo {
    ...
    public static boolean ifRustCode=false;//生成C++代码
...
//    public static String directory="E:"+File.separator+"qurong"+File.separator+"compilerTest";//python文法路径
    ...
    public static void setConfiguration() {
        ...
        if(ifJavaCode){
            ...
            RustConfigureInfo.setKeyWords();//设置关键字表
            RustConfigureInfo.setVarnames();//设置变量标识符引用文法token表
            RustConfigureInfo.setCBaseType();//设置c基本类型
            RustConfigureInfo.setCBaseTypeLiteral();//设置c基本类型的直接生成文法
            RustConfigureInfo.setCBaseTypeExp();//设置c基本类型的表达式文法
            RustConfigureInfo.setScopeGrammars();//设置c中开启新的作用域相关文法
            RustConfigureInfo.setLoopGrammars();//设置c中循环相关文法
            RustConfigureInfo.setDivisorGrammars();//设置c中除数相关文法
            RustConfigureInfo.setVarnamesMap();//设置c中基本类型变量名称文法和基本类型关键字映射表
            RustConfigureInfo.setStatementGrammars();//设置c中新的语句文法
            RustConfigureInfo.setVarnameCategoryMap();//设置变量的类别，变量、数组、指针
            RustConfigureInfo.setDefineOrModifyGrammars();//设置c中定义或修改标识符取值的文法
            RustConfigureInfo.setscopeBodyGrammars();//设置c中作用域体相关的文法
            RustConfigureInfo.setMutationStrategies();//设置变异策略集合
    ...
    public static List<String> getBaseTypes() {
        if(ifJavaCode){
            ...
            return RustConfigureInfo.rustBaseType;//基本类型
        }
        else{
            return null;
        }
    ...
    public static int getCycleStepLengthMax() {
        if(ConfigureInfo.ifJavaCode){
            ...
            return RustConfigureInfo.cycleStepLengthMax;
        }else{
    ...
    public static int getCycleStepLength() {
        ...
        if(ConfigureInfo.ifJavaCode){
            ...
            return RustConfigureInfo.cycleStepLength;
        }else{
            return ConfigureInfo.cycleStepLength;
        }
    }
    ...
    public static int getStarnum() {
        ...
        if(ConfigureInfo.ifJavaCode){
            ...
            return RustConfigureInfo.starnum;
        }else{
            return ConfigureInfo.starnum;
        }
    }
    ...
    public static int getAddnum() {
        ...
        if(ConfigureInfo.ifJavaCode){
            ...
            return RustConfigureInfo.addnum;
        }else{
            return ConfigureInfo.addnum;
        }
    }
    ...
    public static int getLoopCountMax() {
        ...
        if(ConfigureInfo.ifJavaCode){
            ...
            return RustConfigureInfo.loopCountMax;
        }else{
            return ConfigureInfo.loopCountMax;
        }
    }
    ...
    public static int getTerminateMaxFindLen() {
        if(ConfigureInfo.ifJavaCode){
            ...
            return RustConfigureInfo.terminateMaxFindLen;
        }else{
    ...
    public static int getMoreThanOneRoot() {
        if(ConfigureInfo.ifJavaCode){
            ...
            return RustConfigureInfo.moreThanOneRoot;
        }else{
    ...
    public static void setMoreThanOneRoot(int num) {
        if(ConfigureInfo.ifJavaCode){
            ...
            RustConfigureInfo.moreThanOneRoot=num;
        }else{
    ...
    public static int getNeedsplitNum() {
        if(ConfigureInfo.ifJavaCode){
            ...
            return RustConfigureInfo.needsplitNum;
        }else{
    ...
    public static void setNeedsplitNum(int num) {
        if(ConfigureInfo.ifJavaCode){
            ...
            RustConfigureInfo.needsplitNum=num;
        }else{
