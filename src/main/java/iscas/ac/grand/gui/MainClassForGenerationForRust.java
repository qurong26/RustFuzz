...
public class MainClassForGenerationForRust {
	private static String grammarPath="grammar/rust";

	private static String language="Rust";
	private static String postfix=".rs";
	...
	private static String generateNum = "1000";
...
//private static String index= "2025-1-23";
	public static void main(String[] args){
		...
		//language
		MainClassForGenerationForRust mcg=new MainClassForGenerationForRust();
	...
	protected void setLanguage(String language) {
		...
		if(language=="C") {
			...
			ConfigureInfo.ifRustCode=false;
		}else if(language=="C++") {
