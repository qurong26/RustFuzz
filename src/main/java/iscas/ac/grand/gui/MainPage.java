...
import iscas.ac.grand.util.FileOperation;
import iscas.ac.grand.util.GlobalVariable;
import iscas.ac.grand.util.ScriptOperation;
...
//		txtChoosenGrammar.setText("H:\\demo\\lambda-template");//lambda 2025-8-15替换
//		txtChoosenGrammar.setText("H:\\compilertest\\front_project\\RustFuzz\\grammar\\SMTlib2");//smtlib2 2025-8-15替换
		txtChoosenGrammar.setText("grammar\\c");//smtlib2 2025-8-15替换
...
//		txtPostfix = new JTextField(".cpp");
		txtPostfix = new JTextField(".smt2");
...
//		txtGenerateResultPath.setText("H:\\demo\\lambda-programs\\2025\\0109\\1");//lambda 2025-8-15替换
//		txtGenerateResultPath.setText("H:\\demo\\smt-programs\\2025\\0815\\1");//smtlib2 2025-8-15替换
//		txtGenerateResultPath.setText("H:\\demo\\cpp-programs\\1211");//cpp in grammar-v4
//		txtGenerateResultPath.setText("D:\\demo\\result");
		txtGenerateResultPath.setText("generate-putput\\c");//2025-11-6
