...
public class RustConfigureInfo {
    ...
    public static final String fieldDeclaration="'let' identifier ':' primitiveType ';'  identifier ('=' expression) ';'";//声明全局变量的文法
    public static final String localDeclaration="'let' identifier ':' primitiveType ';'  identifier ('=' expression)";//声明局部变量的文法
...
//    public static final String lamdaExpression="renameLamda lamdaCaptureList lamdaParameterList lamdaSpecifiersException lamdaType lamdaFunctionBody callParameter";//声明lamda表达式的文法
    public static final String ExpressionInBlock="ExpressionInBlock";//声明块中的表达式的文法
    ...
    public static final String methodDeclaration="'fn' identifier  formalParameters  '->' typeTypeOrVoid methodBody";//方法声明文法token
//    public static final String methodDeclaration="'fn' identifier '(' formalParameters ')' '->' typeTypeOrVoid methodBody";//方法声明文法token
    ...
    public static String loopCountType="i32";//用于防止死循环的计数变量类型
	...
	public static final String Typename = "i32";//template中的typename在实例化对象时的类型
    ...
    public static List<String> rustBaseType=new ArrayList<>();//c基本类型
    public static void setCBaseType() {
    	rustBaseType.add("i32");
    	rustBaseType.add("float");
    	rustBaseType.add("double");
    	rustBaseType.add("void");
    	rustBaseType.add("i16");
    	rustBaseType.add("i64");
    	rustBaseType.add("bool");
    	rustBaseType.add("int*");
    	rustBaseType.add("int[]");
    }

    public static Map<String,String> rustBaseTypeLiteral=new HashMap<>();//c基本类型的生成文法
    public static void setCBaseTypeLiteral() {
    	rustBaseTypeLiteral.put("i32","integerLiteral");
    	rustBaseTypeLiteral.put("float","floatLiteral");
    	rustBaseTypeLiteral.put("double","floatLiteral");
    	rustBaseTypeLiteral.put("bool","BOOL_LITERAL");
    	rustBaseTypeLiteral.put("i64","longLiteral");
    	rustBaseTypeLiteral.put("i16","shortLiteral");
    	rustBaseTypeLiteral.put("int*","pointerLiteral");
    	rustBaseTypeLiteral.put("int[]","arrayLiteral");
    	rustBaseTypeLiteral.put("void","");
    }
    public static Map<String,String> rustBaseTypeExp=new HashMap<>();//c基本类型的生成文法
    public static void setCBaseTypeExp() {
    	rustBaseTypeExp.put("i32","integerExpression");
    	rustBaseTypeExp.put("float","floatExpression");
    	rustBaseTypeExp.put("double","floatExpression");
    	rustBaseTypeExp.put("bool","boolExpression");
    	rustBaseTypeExp.put("i64","longExpression");
    	rustBaseTypeExp.put("i16","shortExpression");
    	rustBaseTypeExp.put("int*","pointerExpression");
    	rustBaseTypeExp.put("int[]","arrayExpression");
    	rustBaseTypeExp.put("void","");
    }

    public static Map<String,String> varnamesMap=new HashMap<>();//基本类型文法和对应的关键字映射表
    public static  void setVarnamesMap(){
        varnamesMap.put("integerVarName","i32");
        varnamesMap.put("shortVarName","i16");
        varnamesMap.put("longVarName","i64");
...
//        varnamesMap.put("boolVarName","int");//c语言没有bool,这里调整为int
        varnamesMap.put("floatVarName","i32");
        varnamesMap.put("pointerVarName","i32");
        varnamesMap.put("arrayVarName","i32");
        varnamesMap.put("boolVarName","i32");
    }
